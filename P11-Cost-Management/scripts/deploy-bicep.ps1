...
New-AzDeployment -Name "Deploy-AIO-Cost-Management-$random" -Location $location -TemplateFile '../bicep/main.bicep' -TemplateParameterFile '../parameters/main.parameters.json' -deploymentid $random 