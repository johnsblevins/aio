...
New-AzDeployment -Name "Deploy-AIO-Image-Gallery-$random" -Location $location -TemplateFile '../bicep/main.bicep' -TemplateParameterFile '../parameters/main.parameters.json' -deploymentid $random 